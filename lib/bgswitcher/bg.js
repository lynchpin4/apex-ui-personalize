...
function bgCt(colors)
{
  ...
  out['ui_spacer_use'] = bg.functions.saturate(out['ui_spacer_use'], { value: 70 });
  out['ui_spacer_use'] = bg.functions.lighten(out['ui_spacer_use'], { value: 20 });
  out['ui_spacer'] = out['ui_spacer_use'];

  out['ui_property_use'] = bg.functions.saturate(out['ui_property_use'], { value: 25 });
  out['ui_property_use'] = bg.functions.lighten(out['ui_property_use'], { value: 15 });
